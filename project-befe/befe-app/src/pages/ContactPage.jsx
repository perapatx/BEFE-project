...
<div className="container mx-auto px-4 py-12">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-yellow-200">
                <h2 className="text-2xl font-bold text-red-700 mb-6">ข้อมูลการติดต่อ</h2>
                
                <div className="space-y-6">
                  <div className="flex items-start">
                    <LocationMarkerIcon className="h-6 w-6 text-red-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">ที่อยู่</h3>
                      <p className="text-gray-600">
                        123 ถนนบอร์ดเกม แขวงเกมสนุก<br/>
                        เขตความสุข กรุงเทพฯ 10200
                      </p>
                    </div>
                  </div>

                  <div className="flex items-start">
                    <PhoneIcon className="h-6 w-6 text-red-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">โทรศัพท์</h3>
                      <p className="text-gray-600">02-123-4567</p>
                      <p className="text-gray-600">065-123-4567</p>
                    </div>
                  </div>

                  <div className="flex items-start">
                    <MailIcon className="h-6 w-6 text-red-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">อีเมล</h3>
                      <p className="text-gray-600">boardgameparadise@gmail.com</p>
                    </div>
                  </div>

                  <div className="flex items-start">
                    <ClockIcon className="h-6 w-6 text-red-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
 ...
 {/* Social Links */}
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-yellow-200">
                <h2 className="text-2xl font-bold text-red-700 mb-6">ส่งข้อความถึงเรา</h2>
                
                {submitted ? (
                  <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg">
                    ขอบคุณที่ติดต่อเรา! เราจะตอบกลับคุณโดยเร็วที่สุด ❤️
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg 
                          focus:ring-2 focus:ring-red-400 focus:border-transparent resize-none"
                      ></textarea>
                    </div>
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="px-8 py-3 bg-red-600 text-white font-semibold rounded-lg 
                          hover:bg-red-700 transition-colors transform hover:scale-105 shadow-md"
                      >
                        ส่งข้อความ
                      </button>
                    </div>
          ...
          <div className="mt-12">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-yellow-200">
              <h2 className="text-2xl font-bold text-red-700 mb-6">แผนที่</h2>
              <div className="bg-red-100 h-96 rounded-lg flex items-center justify-center">
                <p className="text-gray-600">Google Maps จะแสดงที่นี่</p>
              </div>
            </div>
          </div>
        </div>
